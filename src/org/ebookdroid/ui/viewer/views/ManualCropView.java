...
public class ManualCropView extends View {
    ...
    public void applyCropping() {
        ...
        builder.setItems(R.array.list_crop_actions,*/ controller.getOrCreateAction(R.id.actions_applyCrop).run();/*);
    ...
    public void onApply(final ActionEx action) {
        /*final Integer index = 3;action.getParameter(IActionController.DIALOG_ITEM_PROPERTY);
        if (index == null) {
            return;
        }*/
