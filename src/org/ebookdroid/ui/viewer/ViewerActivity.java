...
import org.ebookdroid.EBookDroidMethods;
...
import org.ebookdroid.ui.viewer.views.FooterView;
import org.ebookdroid.ui.viewer.views.HeaderView;
...
public class ViewerActivity extends AbstractActionActivity<ViewerActivity, ViewerActivityController> {
    ...
    protected void onCreateImpl(final Bundle savedInstanceState) {
        ...
        EBD = new EBookDroidMethods(getController(), this);
        ...
        try {
            ...
            frameLayout.addView(getFooterView());
    ...
    protected boolean hasNormalMenu() {
        return false;/*AndroidVersion.lessThan4x || IUIManager.instance.isTabletUi(this) || AppSettings.current().showTitle;*/
    }
