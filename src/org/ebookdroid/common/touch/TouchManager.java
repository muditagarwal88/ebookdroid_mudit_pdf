...
public class TouchManager {
    ...
    public static void loadFromSettings(final AppSettings newSettings) {
        ...
        int ACTION_LEFT_PANE = R.id.actions_verticalConfigScrollUp;
        int ACTION_MIDDLE_PANE = R.id.actions_openOptionsMenu;
        int ACTION_RIGHT_PANE = R.id.actions_verticalConfigScrollDown;
        profiles.clear();
        stack.clear();
                    ...
                    for (int j = 0; j < 3; j++) {
                        ...
                        switch (j) {
                            ...
                            case 1:
                                left = 30;
                                right = 70;
                                id=ACTION_MIDDLE_PANE;
                                break;
                            case 2:
                                left = 70;
                                right = 100;
                                id=ACTION_RIGHT_PANE;
                                break;
                        }

                            final Region r = def.addRegion(left, top, right, bottom);
                            r.setAction(Touch.SingleTap,id, true);

                    }
                }

              /*  final Region r = def.addRegion(0, 0, 30, 25);
                r.setAction(Touch.DoubleTap, R.id.actions_verticalConfigScrollDown, true);
            
            {
                final Region r = def.addRegion(70, 0, 100, 25);
                r.setAction(Touch.DoubleTap, R.id.actions_verticalConfigScrollUp, true);
            }*/
            /*
             * {
