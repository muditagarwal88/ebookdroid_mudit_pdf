...
public class AppSettings implements AppPreferences, BookPreferences, IBackupAgent {
    ...
    private AppSettings() {
        ...
        fullScreen = true;/*FULLSCREEN.getPreferenceValue(prefs);*/
        showTitle = false;/*SHOW_TITLE.getPreferenceValue(prefs);*/
    ...
    static void fillBookSettings(final BookSettings bs) {
        ...
        bs.positiveImagesInNightMode = BOOK_NIGHT_MODE_POS_IMAGES.getPreferenceValue(prefs,
                current.positiveImagesInNightMode);
